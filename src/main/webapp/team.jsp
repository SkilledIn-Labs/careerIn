	...
	<nav class="main-menu">
		...
		<div class="scrollbar" id="style-1">
			<ul>
				...
				<li><a href="/login.jsp"> <i class="fa fas fa-user fa-lg"></i>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4ff17589278d8b3a"></script>
				...
				<ul class="about">
					<li><a href="/perform_logout"> <class
								class="fa  fas fa-sign-out-alt"></class> </i> <span class="nav-text">
								logout </span>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="https://skilledin.file.core.windows.net/pics/sonu.jpg?st=2021-06-02T20%3A01%3A22Z&se=2023-12-03T20%3A01%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=PnwYxW1BJR8%2FsSPUAZi%2FlmqCld2%2BS2QT2TwvLRwuDro%3D"
										alt="" class="img-responsive pics">
									<figcaption>
										<p>Temporibus dolor, quisquam consectetur molestias,
											veniam voluptatum. Beatae alias omnis totam.</p>
