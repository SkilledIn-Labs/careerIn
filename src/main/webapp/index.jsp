...
uri="http://www.springframework.org/tags"%>
	...
	<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Ffacebook.com%2Fstartific&amp;width&amp;layout=button&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=35" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:35px;" allowTransparency="true"></iframe>
                            ...
                            <ul class="about">
                                <li>
                                    <a href="/perform_logout">
                                        <class class="fa fa-lightbulb-o fa-lg fas fa-sign-out-alt"></class>
                                        </i>
                                        <span class="nav-text">
									logout 
								</span>
                ...
                <header>
                    ...
                    <input type="hidden" id="hdnSession" data-value=" ${sessionScope.userName}" />
                ...
                <section class="form-outer" id="first-form">
                    <div class="form-column">
                        <div class="email">
                            ...
                            <input type="text" name="q1" id="q1" placeholder="% out of 100" autocomplete="nope" required />
                        </div>
                        <div class="algo">
                            <label for="q2" id="name-label">Algorithms</label>
                            <input type="text" name="q2" id="q2" placeholder="% out of 100" autocomplete="nope" required />
                        </div>
                        <div class="pc">
                            <label for="q3" id="name-label">Programming Concepts</label>
                            <input type="text" name="q3" id="q3" placeholder="% out of 100" autocomplete="nope" required />
                        </div>
                        <div class="se">
                            <label for="q4" id="name-label">Software Engineering</label>
                            <input type="text" name="q4" id="q4" placeholder="% out of 100" autocomplete="nope" required />
                        </div>

                        <div class="cn">
                            <label for="q5" id="name-label">Computer Networks</label>
                            <input type="text" name="q5" id="q5" placeholder="% out of 100" autocomplete="nope" required />
                        </div>
				...
				-->
                    ...
                    <div class="form-column">
                        <div class="elect">
                            ...
                            <input type="text" name="q6" id="q6" placeholder="% out of 100" autocomplete="nope" required />
                        </div>

                        <div class="cn">
                            <label for="q7" id="name-label">Computer Architecture</label>
                            <input type="text" name="q7" id="q7" placeholder="% out of 100" autocomplete="nope" required />
                        </div>

                        <div class="cn">
                            <label for="q8" id="name-label">Mathematics</label>
                            <input type="text" name="q8" id="q8" placeholder="% out of 100" autocomplete="nope" required />
                        </div>

                        <div class="cn">
                            <label for="q9" id="name-label">Communication Skills</label>
                            <input type="text" name="q9" id="q9" placeholder="% out of 100" autocomplete="nope" required />
                        </div>
                ...
                <section class="form-outer" id="second-form">
                    <div class="form-column">
                        <div class="number">
                            ...
                            <input type="number" name="q10" id="q10" placeholder="Enter a valid hour" min="0" max="24" required />
                        </div>
                        <div class="number">
                            <label for="q11" id="number-label">How would you rate yourself in Logical quotient</label>
                            <input type="number" name="q11" id="q11" placeholder="Enter a valid number" min="1" max="10" required />
                        </div>


                        <div class="number">
                            <label for="q12" id="number-label">Number of hackathon(s) participated</label>
                            <input type="number" name="q12" id="q12" placeholder="Enter a valid number" min="0" max="100" required />
                        </div>


                        <div class="number">
                            <label for="q13" id="number-label"> coding skills rating</label>
                            <input type="number" name="q13" id="q13" placeholder="out of 10" min="0" max="100" required />
                        </div>

                        <div class="number">
                            <label for="q14" id="number-label">Public Speaking Points</label>
                            <input type="number" name="q14" id="q14" placeholder="out of 10" min="0" max="10" required />
                        </div>
