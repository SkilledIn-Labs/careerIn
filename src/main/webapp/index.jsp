...
<html lang="en" xmlns:th="http://www.thymeleaf.org">
  ...
  <body>
   ...
   <li>                                 
   <a href="http://startific.com">
   <i class="fa fa-envelope-o fa-lg fas fa-envelope"></i>
   ...
   <li>
					  <a href="/perform_logout">
							<class class="fa fa-lightbulb-o fa-lg fas fa-sign-out-alt"></class></i>
						   <span class="nav-text">
							   logout 
						   </span>
   ...
   <li>
	<a href="http://startific.com">
	<i class="fa fa-heart-o fa-lg fas fa-users"></i>
