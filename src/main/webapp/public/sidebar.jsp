	...
	<div class="d-flex align-items-center logo-box justify-content-start">	
		...
		<a href="index.html" class="logo">
		  ...
		  <div class="logo-mini w-50">
			  <span class="light-logo"><img src="https://skilledin.file.core.windows.net/pics/logo.png?st=2021-06-06T03%3A57%3A37Z&se=2023-06-07T03%3A57%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=3NYPj56x8g%2BsKTK8dtBmtQNzKewVBXSfRQxGLyKxXD0%3D" alt="logo"></span>
			  <span class="dark-logo"><img src="../images/logo-letter.png" alt="logo"></span>
		  </div>
		  <div class="logo-lg">
			  <span class="light-logo"><img src="https://skilledin.file.core.windows.net/pics/skilledIn.png?st=2021-06-06T03%3A58%3A18Z&se=2023-06-07T03%3A58%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=FgZFn%2BdbvdWO0VS4Ora%2FHS1sAYI9zO5GOhdcWEEwNXI%3D" alt="logo"></span>
			  ...
			  <div class="sidebar-widgets">
				  <div class="mx-25 mb-30 pb-20 side-bx bg-primary-light rounded20">
					<div class="text-center">
						<img src="https://multipurposethemes.com/admin/rhythm-admin-template/bs5/images/svg-icon/color-svg/custom-17.svg" class="sideimg p-5" alt="">
